   ...
   <form action="{{ route("formapago.reportExcelSolicitud") }}" method="GET	">
  		<div class="form-row">
  			    <div class="form-group">
		   		...
		   		<input type="text" id="correo" name="correo" class="form-control" style="height:35px; width:30%" autocomplete="off" maxlength="0" readonly="true"  value="{{$tickets[0]->correo_cliente ? $tickets[0]->correo_cliente : ' ' }}  ">
