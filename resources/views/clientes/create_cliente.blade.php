	   ...
	   <form action="" method="post">
		   ...
		   <br>
		    ...
		    <div class="form-group">
		   		...
		   		<input type="text" id="nombre" name="nombre" class="date form-control"/>
		   </div>

		       <div class="form-group">
		   		<label for="telefono">Teléfono</label>
		   		<input type="text" id="telefono" name="telefono" class="form-control" 	 style="height:35px; width:240px"/>
		   </div>
		   
		       <div class="form-group">
		   		<label for="telefono_alt">Teléfono Alternativo</label>
		   		<input type="text" id="telefono_alt" name="telefono_alt" class="form-control" 	 style="height:35px; width:240px"/>
		   </div>

		     
		       <div class="form-group">
		   		<label for="correo_alt">Correo Alternativo</label>
		   		<input type="text" id="correo_alt" name="correo_alt" class="form-control" 	 style="height:35px; width:240px"/>
		 	  </div>

		     <div class="form-group">
		   		<label for="cod_area">Código de Área</label>
		   		<input type="text" id="cod_area" name="cod_area" class="form-control" 	 style="height:35px; width:240px"/>
		   </div>
